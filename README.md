...
* 実装サンプールは[こちら](http://www.alij.ne.jp)にあります。
...
a)	全角文字を送信する場合は文字コードをUTF-8で送信する必要があります。
※モバイルの場合は文字コードをShift_JISで送信する必要があります。
...
尚、次回以降の決済時には初回で決済したお客様の特定情報が必要になりますので加盟店様でお客様のデータを管理して頂く必要があります。
...
実装方法は[ｘｘｘｘ](http://www.google.com)をご参照ください。
...
|:----------------|:------------------- |:------|:-----|
|IPアドレス　　　　　　　　|setVisibility_ipAdr  |boolean|false|
|郵便番号          |setVisibility_zip    |boolean|false|
|都道府県          |setVisibility_capital|boolean|false|
|住所１            |setVisibility_adr1   |boolean|false|
|住所２            |setVisibility_adr2   |boolean|false|
|名前              |setVisibility_name   |boolean|false|
|メール              |setVisibility_mail  |boolean|false|
|国                |setVisibility_country|boolean|false|
|電話番号           |setVisibility_tel   |boolean|false|
